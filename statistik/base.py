...
class BaseAPI:
    ...
    def get_or_404(self, model, item_id: int, id_field: str):
        # getattr ... sucht in der DB nach der ordner_id spalte und wenn es diese gefunden hat, dann schaut es die restlichen eigenschaften des ordners wie title des ordners an.
