...
# Link Repository: 
https://github.com/aleksandra217/DBI_Projekt_Aleksandra_Vidovic_Tamara_Kaselj.git

- Im Anhang bei der Endabgae ist nochmals das Projekt mitdrinnen. Aufgrund von irgendeinem Problem in GIT, hat es mir 3 dateien nicht auf git mit hochgeladen. Anbei ist hier drinnen die requirements.txt, update_db.py und welche_db.py.
